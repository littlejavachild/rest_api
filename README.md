...
3. Update the Heroku `MONGODB_URI` by executing: `heroku config:set MONGODB_URI=<ngrok_url>`
...
Response:  
 ...
 To search for a specific product, use the name of the field followed by a value. For example, to find products with category shoes, execute the following `curl` command:  
